...
M.highlights_base = function(colors, opts)
	return {
		...
		Visual = { bg = colors.brightblack, fg = colors.background },
		...
		["@type"] = { fg = colors.red }, -- For types.
		["@type.builtin"] = { fg = colors.red }, -- For builtin types.
		...
		["@property"] = { fg = colors.brightwhite }, -- Same as TSField.
		-- Identifiers
		...
		["@constant"] = { fg = colors.red }, -- For constants
